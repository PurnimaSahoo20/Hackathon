...
urlpatterns = [
    ...
    path('communication/send-message/', views.team_send_support_message, name='team_send_support_message_comm'),
    ...
    path('details/remove-member/<int:member_index>/', views.team_remove_member, name='team_remove_member'),
    ...
    path('details/tshirt-size-guidelines/', views.tshirt_size_guideline_pdf, name='tshirt_size_guideline_pdf'),
]
